...
pipeline {
    ...
    environment {
        ...
        DISCORD_PREFIX = "Job: Vignette Branch: ${BRANCH_NAME} Build: #${BUILD_NUMBER}"
    ...
    stages {
        ...
        stage('publish') {
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'maven-lex-user', usernameVariable: 'MAVEN_USER', passwordVariable: 'MAVEN_PASSWORD')]) {
                    withGradle {
